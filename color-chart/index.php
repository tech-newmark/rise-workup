...
$APPLICATION->SetPageProperty("description", "Карта цветов продукции RISE: доступные оттенки материалов для сумок, рюкзаков, шопперов и аксессуаров. Информация для подбора цвета при заказе.");
$APPLICATION->SetPageProperty("title", "Карта цветов продукции | RISE");
