...
$MESS["SEARCH_GO"] = "Найти";
$MESS["SEARCH_PREVIEW_TEXT"] = "Введите интересующий вас запрос в строке поиска.";
$MESS["SEARCH_ERROR"] = "Пустой поисковый запрос! Исправьте поисковую фразу и повторите поиск.";
