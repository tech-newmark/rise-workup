...
?>
<section class="section catalog-search">
	<div class="container">
		<? if (Loader::includeModule('search')) {
			...
			if (!empty($arElements) && is_array($arElements)) {
				$arElements = array_values(array_filter($arElements, static function ($itemId) { // отбрасываем ID разделов (содержащие буквы), оставляем только элементы с числовыми ID
					return ctype_digit((string)$itemId);
				}));
		...
		?>
			<p class="catalog-search__text">
				<?= $isSearchNotFound ? GetMessage("CT_BCSE_NOT_FOUND") : 'Пожалуйста, введите название товара для поиска'; ?>
			</p>
		<?
		}
		?>
