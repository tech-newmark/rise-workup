...
<section class="service-detail">
	...
	<!-- Примеры наших работ -->
	<?
	$GLOBALS['arLinkedImagesFilter'] = array('ID' => $arResult['PROPERTIES']['LINKED_IMAGES']['VALUE']);
	$APPLICATION->IncludeComponent(
		"bitrix:news.list",
		"examples-list",
		array(
	...
	<!-- Тизеры -->
	<?
	$GLOBALS['arLinkedTizzersFilter'] = array('ID' => $arResult['PROPERTIES']['LINKED_TIZZERS']['VALUE']);
	$APPLICATION->IncludeComponent(
		"bitrix:news.list",
		"tizzers",
		array(
			"SHOW_TITLE" => "Y",
			"CUSTOM_TITLE" => "Кому подходят оптовые поставки RISE",
			"COLUMN_VIEW" => "Y",
			"ACTIVE_DATE_FORMAT" => "d.m.Y",
			"ADD_SECTIONS_CHAIN" => "N",
			"AJAX_MODE" => "N",
	...
	<!-- Преимущества -->
	<?
	$GLOBALS['arLinkedAdvantagesFilter'] = array('ID' => $arResult['PROPERTIES']['LINKED_ADVANTAGES']['VALUE']);
	$APPLICATION->IncludeComponent(
		"bitrix:news.list",
		"tizzers",
		array(
			"SHOW_TITLE" => "Y",
			"CUSTOM_TITLE" => "Наши преимущества",
			"ACTIVE_DATE_FORMAT" => "d.m.Y",
			"ADD_SECTIONS_CHAIN" => "N",
			"AJAX_MODE" => "N",
			"AJAX_OPTION_ADDITIONAL" => "",
	...
	<!-- Этапы -->
	<?
	$GLOBALS['arLinkedStagesFilter'] = array('ID' => $arResult['PROPERTIES']['LINKED_STAGES']['VALUE']);
	$APPLICATION->IncludeComponent(
		"bitrix:news.list",
		"tizzers",
		array(
	...
	<!-- "FAQ" -->
	<?
	$GLOBALS['arLinkedFaqFilter'] = array('ID' => $arResult['PROPERTIES']['LINKED_FAQ']['VALUE']);
	$APPLICATION->IncludeComponent(
		"bitrix:news.list",
		"faq-preview",
		array(
