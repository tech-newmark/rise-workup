(function () {
	...
	BX.Sale.BasketComponent = {
		...
		// 	var block = this.getEntity(node, "basket-item-quantity-block");
		// 	if (block) {
		// 		// Убраны обработчики startEventName и endEventName
		// 		// Оставлен только обработчик click для минуса
		// 		entity = this.getEntity(block, "basket-item-quantity-minus");
		// 		if (entity) {
		// 			BX.bind(entity, "click", BX.proxy(this.quantityMinus, this));
		// 		}
		...
		// 		// Убраны обработчики startEventName и endEventName
		// 		// Оставлен только обработчик click для плюса
		// 		entity = this.getEntity(block, "basket-item-quantity-plus");
		// 		if (entity) {
		// 			BX.bind(entity, "click", BX.proxy(this.quantityPlus, this));
		// 		}

		// 		// Поле ввода количества (оставлено без изменений)
		// 		entity = this.getEntity(block, "basket-item-quantity-field");
		// 		if (entity) {
		// 			BX.bind(entity, "change", BX.proxy(this.quantityChange, this));
		// 		}
