<?php
// В этом файле ненужный код закомментирован !
			...
			<form action="<?= POST_FORM_ACTION_URI ?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
				...
				<div id="bx-soa-order" class="grid" style="opacity: 0">
					...
					<div class="bx-soa grid__item grid__item--main">
						...
						?>
							<!--	BASKET ITEMS BLOCK	-->
							<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active order__block">
								<div class="bx-soa-section-title-container">
									<h2 class="bx-soa-section-title">
										<?= $arParams['MESS_BASKET_BLOCK_NAME'] ?>
									</h2>
									<div class="text-right"><a href="javascript:void(0)" class="bx-soa-editstep"><?= $arParams['MESS_EDIT'] ?></a></div>
								</div>
								<div class="bx-soa-section-content container-fluid"></div>
							</div>
						<?php
						...
						*/ ?>
						...
						<!--	REGION BLOCK	-->
						<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active order__block">
							<div class="bx-soa-section-title-container">
								<h2 class="bx-soa-section-title">
						...
						<!--	BUYER PROPS BLOCK	-->
						<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active order__block">
							<!-- <div class="bx-soa-section-title-container">
								<h2 class="bx-soa-section-title">
						...
						<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
							<!--	PAY SYSTEMS BLOCK	-->
							<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active order__block">
								<div class="bx-soa-section-title-container">
									<h2 class="bx-soa-section-title">
							...
							<!--	DELIVERY BLOCK	-->
							<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active order__block" <?= ($hideDelivery ? 'style="display:none"' : '') ?>>
								<div class="bx-soa-section-title-container">
									<h2 class="bx-soa-section-title">
						...
						*/ ?>
						...
						<div id="bx-soa-orderSave">
							...
							<a href="javascript:void(0)" style="margin: 10px 0" class="pull-right btn btn-default btn-lg" data-save-button="true">
								<?/*= $arParams['MESS_ORDER'] */ ?>
							</a>
						</div> -->
