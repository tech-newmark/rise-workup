		...
		<div class="container">
			...
			?>
				...
				<div class="order__header">
					...
					?>
						<a class="main-btn sale-order-history-link" href="<?= $APPLICATION->GetCurPageParam("filter_history=Y", $clearFromLink, false) ?>">
					...
					if ($filterHistory === 'Y') {
					?>
						<a class="main-btn  sale-order-history-link" href="<?= $APPLICATION->GetCurPageParam("", $clearFromLink, false) ?>">
						...
						?>
							<a class="main-btn  sale-order-history-link" href="<?= $APPLICATION->GetCurPageParam("filter_history=Y&show_canceled=Y", $clearFromLink, false) ?>">
				...
				?>
					<div class="row col-md-12 col-sm-12">
						<a class="main-btn outlined" href="<?= htmlspecialcharsbx($arParams['PATH_TO_CATALOG']) ?>" class="sale-order-history-link">
