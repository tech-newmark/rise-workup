...
<form action="<?php echo $arResult['FORM_ACTION'] . ($_SERVER['QUERY_STRING'] <> '' ? '?' . htmlspecialcharsbx($_SERVER['QUERY_STRING']) : '') ?>" method="post">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
		<thead>
			<tr>
				<td colspan="2"><?php echo GetMessage('subscr_auth_sect_title') ?></td>
			</tr>
		</thead>
		<tr valign="top">
			<td width="40%">
		...
		<tfoot>
			<tr>
				<td colspan="2"><input type="submit" name="autorize" value="<?php echo GetMessage('adm_auth_butt') ?>" /></td>
			</tr>
		</tfoot>
	</table>
...
<form action="<?= $arResult['FORM_ACTION'] ?>">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
		<thead>
			<tr>
				<td colspan="2"><?php echo GetMessage('subscr_pass_title') ?></td>
			</tr>
		</thead>
		<tr valign="top">
			<td width="40%">
		...
		<tfoot>
			<tr>
				<td colspan="2"><input type="submit" name="sendpassword" value="<?php echo GetMessage('subscr_pass_button') ?>" /></td>
			</tr>
		</tfoot>
	</table>
