...
<form action="<?= $arResult['FORM_ACTION'] ?>" method="get">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
		<thead>
			<tr>
				<td colspan="2"><?php echo GetMessage('subscr_title_confirm') ?></td>
			</tr>
		</thead>
		<tr valign="top">
			<td width="40%">
				<p><?php echo GetMessage('subscr_conf_code') ?><span class="starrequired">*</span><br />
					<input type="text" name="CONFIRM_CODE" value="<?php echo $arResult['REQUEST']['CONFIRM_CODE']; ?>" size="20" />
				</p>
		...
		<tfoot>
			<tr>
				<td colspan="2"><input type="submit" name="confirm" value="<?php echo GetMessage('subscr_conf_button') ?>" /></td>
			</tr>
		</tfoot>
	</table>
