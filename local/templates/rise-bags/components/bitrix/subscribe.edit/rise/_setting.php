...
<form action="<?= $arResult['FORM_ACTION'] ?>" method="post">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
		<thead>
			<tr>
				<td colspan="2"><?php echo GetMessage('subscr_title_settings') ?></td>
			</tr>
		</thead>
		<tr valign="top">
			<td width="40%">
				...
				<p><?php echo GetMessage('subscr_fmt') ?><br />
					<label><input type="radio" name="FORMAT" value="text" <?php echo ($arResult['SUBSCRIPTION']['FORMAT'] == 'text') ? 'checked' : ''; ?> /><?php echo GetMessage('subscr_text') ?></label>&nbsp;/&nbsp;<label><input type="radio" name="FORMAT" value="html" <?php echo ($arResult['SUBSCRIPTION']['FORMAT'] == 'html') ? 'checked' : ''; ?> />HTML</label>
				</p>
			</td>
			<td width="60%">
